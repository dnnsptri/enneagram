                            ...
                            <FormItem>
                              <FormControl>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <FormLabel htmlFor="r1">Helemaal niet mee eens</FormLabel>
                                </div>
                              </FormControl>
                            </FormItem>
                            <FormItem>
                              <FormControl>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <FormLabel htmlFor="r2">Niet mee eens</FormLabel>
                                </div>
                              </FormControl>
                            </FormItem>
                            <FormItem>
                              <FormControl>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <FormLabel htmlFor="r3">Neutraal</FormLabel>
                                </div>
                              </FormControl>
                            </FormItem>
                            <FormItem>
                              <FormControl>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <FormLabel htmlFor="r4">Mee eens</FormLabel>
                                </div>
                              </FormControl>
                            </FormItem>
                            <FormItem>
                              <FormControl>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <FormLabel htmlFor="r5">Helemaal mee eens</FormLabel>
                                </div>
                              </FormControl>
                            </FormItem>
                          </RadioGroup>
